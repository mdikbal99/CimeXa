package com.ikbal.admin.viewAndEditProject.controller;
...
import com.ikbal.admin.viewAndEditProject.service.ViewAndEditProjectService;
@Controller
@RequestMapping("/")
...
public class ViewAndEditProjectController {
	...
	public ModelAndView viewandEditProjectController(CreateProjectDTO createprojectDTO) {
		...
		viewandeditProjectService.updateProjectStatus(createprojectDTO);
