...
<body>
	...
	<div class="common">
		<div class="container">
			<form class="actions vertical" action="createIssue.do" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<select id="project" class="form-control" name="projectName">
							<option></option>
				...
				<div class="form-group">
					<label for="assignProject" class="col-sm-3 control-label">Assign
						To</label>
					<div class="col-sm-9">
						<select id="assignProject" class="form-control"
							name="resourceEmail">
							<option>-----select------</option>
							<c:forEach items="${res}" var="data">
								<option value="${data.email}">${data.rname}</option>
							</c:forEach>
						</select>
					</div>
				</div>
